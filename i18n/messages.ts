...
export const errorMessages = {
  ru: {
    ...
    PRINCIPAL_EXISTS: "Владельцем уже отмечен другой мастер — снимите отметку с него",
    ...
    BOOKING_NOT_STARTED: "Визит ещё не начался — закрыть его можно с его времени",
  ...
  ro: {
    ...
    PRINCIPAL_EXISTS: "Un alt maestru este deja marcat ca proprietar — scoateți-i marcajul",
    ...
    BOOKING_NOT_STARTED: "Vizita nu a început încă — o puteți închide de la ora ei",
  ...
  en: {
    ...
    PRINCIPAL_EXISTS: "Another master is already marked as the owner — unmark them first",
    ...
    BOOKING_NOT_STARTED: "This visit has not started yet — it can be closed from its own time",
