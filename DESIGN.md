...
2. **Показывать расчёт.** Любая сумма раскрывается до комиссии, налогов и времени.
...
- **Фактура:** тёплая бумага, фарфор, чернила, терракотовая отметка, зелёная прибыль.
...
| `sage` | `#8E9D84` | Нейтральный secondary |
...
- Form gap: 16 px; dense table rows: 12 px vertical.
...
- Для прибыли, затрат и времени применять разные формы, а не только разные цвета.
...
- Outcome-first: «Останется вам 360 MDL», затем объяснение.
- Не писать «Contribution margin» без расшифровки.
- Не писать «Успешно выполнено». Писать, что изменилось: «Визит закрыт. Прибыль визита: 360 MDL».
- Warning сообщает действие: «У 3 услуг не указана цена. Добавьте её в каталоге».
